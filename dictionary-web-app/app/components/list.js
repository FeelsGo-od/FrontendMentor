        ...
        {synonyms.length !== 0 ? 
            (<div className="pb-[1.5rem] md:pb-[1rem] pt-[0.15rem] md:pt-[0.6rem]">
                ...
                {synonyms.map((synonym, i) => (
                    <span key={i} className={`${inter700.variable} font-inter700 break-all text-violet text-[1rem] leading-[1.188rem] md:text-[1.25rem] md:leading-6 ml-[0.84rem]`}>{synonym}{synonyms.length > 1 && ','}</span>
                ))}
            </div>) 
        : ''}
        ...
        {antonyms.length !== 0 ? 
            (<div className="pb-[1rem] md:pb-[1rem] pt-[0.4rem] md:pt-[0.6rem]">
                ...
                {antonyms.map((antonym, i) => (
                    <span key={i} className={`${inter700.variable} font-inter700 break-all text-violet text-[1rem] leading-[1.188rem] md:text-[1.25rem] md:leading-6 ml-[0.84rem]`}>{antonym}{antonyms.length > 1 && ','}</span>
                ))}
            </div>) 
        : ''}
    </li>
