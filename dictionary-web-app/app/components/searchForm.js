...
export default function SearchForm() {
  ...
  return (
    <>
      <form onSubmit={handleSearching} className={`nav_search-bar bg-F4 flex items-center border ${error ? 'border-red' : 'border-transparent'} hover:border-violet transition duration-150 ease-in-out rounded-2xl px-6 h-[3.1rem] md:h-[4.1rem] mt-6 md:mt-[3.188rem] justify-between`}>
