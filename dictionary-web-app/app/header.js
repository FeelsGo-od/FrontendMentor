        ...
        <nav className="flex justify-between">
            ...
            <div className="nav_func flex items-center">
                <div className="nav_func-left">
                    <div id="select_opt-arrow" className={`font-bold bg-transparent text-[0.875rem] leading-[1.188rem] md:text-[1.125rem] md:leading-normal text-2D appearance-none`}>
                        <p onClick={() => dispatch({ type: 'SANS-SERIF' })} className='cursor-pointer'>Sans Serif</p>
                        <p onClick={() => dispatch({ type: 'SERIF' })} className='cursor-pointer'>Serif</p>
                        <p onClick={() => dispatch({ type: 'MONO' })} className='cursor-pointer'>Mono</p>
                    </div>
                </div>
