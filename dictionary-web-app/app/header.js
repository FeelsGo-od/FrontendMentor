...
export default function Header() {
  return (
    <header className="px-[1.875rem] md:px-[2.438rem] pt-[1rem] mxl:px-[22rem]">
        ...
        <input type="text" value='keyboard' className={`${inter700.variable} font-inter700 w-[90%] text-[1rem] leading-[1.188rem] md:text-[1.25rem] bg-transparent focus:outline-none`}/>
