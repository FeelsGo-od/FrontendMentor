...
import { inter700 } from "./elements/fonts"
...
export default function RootLayout({ children }) {
 return (
    <html lang="en">
      <body>
        <header className="px-[1.875rem] pt-[1rem]">
          <nav className="flex justify-between">
            <Image className="nav_logo w-[2.438rem]" src={'images/logo.svg'} width={28} height={32} alt="Dictionary app main page" />
            <div className="nav_func flex items-center">
              ...
              <div className="nav_func-right flex items-center border-l border-E9 pl-4 ml-4">
                <div className="switch-theme-bg w-10 h-5 bg-75 rounded-xl">
                  <div className="circle w-3.5 h-3.5 bg-FF rounded-2xl"></div>
                </div>
                <svg className="ml-3" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="nav_search-bar bg-F4 flex items-center rounded-2xl px-6 py-4 mt-6 justify-between">
        ...
        {children}
        <footer className="px-10 pt-[2rem]">
          <div className="w-full bg-E9 h-px"></div>
          <ul className="flex flex-wrap pt-[1.5rem]">
            <li className="text-75 text-[0.875rem] leading-[1.375rem] underline">Source</li>
            <li className="w-full"><a href="/" className="link-red break-all underline text-2D text-[0.875rem] leading-[1.063rem]">https://en.wiktionary.org/wiki/keyboard</a></li>
          </ul>
        </footer>
      </body>
    </html>
