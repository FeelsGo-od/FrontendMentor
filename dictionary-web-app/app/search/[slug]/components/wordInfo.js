                    ...
                    {wordData.meanings[0].synonyms.length !== 0 && (
                        <div className="pt-[1.5rem] md:pt-[2rem]">
                            ...
                            {wordData.meanings[0].synonyms.map((synonym, i) => (
                                <span key={i} className={`${inter700.variable} font-inter700 break-all text-violet text-[1rem] leading-[1.188rem] md:text-[1.25rem] md:leading-6 ml-[0.84rem]`}>{synonym}{wordData.meanings[0].synonyms.length > 1 && ','}</span>
                            ))}
                        </div>
                    )}
                    {wordData.meanings[0].antonyms.length !== 0 && (
                        <div className="pt-[1.5rem] md:pt-[2rem]">
                            ...
                            {wordData.meanings[0].antonyms.map((antonym, i) => (
                                <span key={i} className={`${inter700.variable} font-inter700 break-all text-violet text-[1rem] leading-[1.188rem] md:text-[1.25rem] md:leading-6 ml-[0.84rem]`}>{antonym}{wordData.meanings[0].antonym.length > 1 && ','}</span>
                            ))}
                        </div>
                    )}
                </div>
