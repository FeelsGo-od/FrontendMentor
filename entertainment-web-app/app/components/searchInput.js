...
export default function SearchInput({ setSearchInput, moviesForSearch, setSearchResult }) {
  ...
  return (
    <form className={`${styles.searchForm} pd16`}>
        ...
        <input onChange={(e) => handleInputChange(e)} className={styles.searchInput} type='text' placeholder='Search for movies or TV series' />
    </form>
  )
}
